...
describe("issue references", () => {
  ...
  it("parses relative and absolute issue hrefs", () => {
    ...
    expect(parseIssueReferenceHref("https://proactiva.us/PAP/issues/pap-789#comment-1")).toEqual({
      identifier: "PAP-789",
    });
    expect(parseIssueReferenceHref("https://proactiva.us/projects/PAP-789")).toBeNull();
  });
