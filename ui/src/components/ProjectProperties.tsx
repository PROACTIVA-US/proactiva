...
import type { Project } from "@proactiva/shared";
          ...
          <div className="space-y-2 rounded-md border border-border/70 p-3">
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="min-w-0 space-y-1">
                  ...
                  {codebase.origin === "managed_checkout" && (
                    <div className="text-[11px] text-muted-foreground">Proactiva-managed folder.</div>
                  )}
                </div>
                <div className="flex items-center gap-1">
                  <Button
            ...
            {hasAdditionalLegacyWorkspaces && (
              <div className="text-[11px] text-muted-foreground">
                Additional legacy workspace records exist on this project. Proactiva is using the primary workspace as the codebase view.
              </div>
            )}
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <DraftInput
                            ...
                            immediate
                            className="w-full rounded border border-border bg-transparent px-2 py-1 text-xs font-mono outline-none"
                            placeholder=".proactiva/worktrees"
                          />
                        </div>
                        <div>
                          <div className="mb-1 flex items-center gap-1.5">
