...
- `PROACTIVA_APPROVAL_ID` — the resolved approval
- `PROACTIVA_APPROVAL_STATUS` — `approved` or `rejected`
- `PROACTIVA_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
