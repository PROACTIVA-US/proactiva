/**
 * Bundling presets for Proactiva plugins.
 *
 ...
 * to match the Proactiva plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@proactiva/plugin-sdk/ui",
    "@proactiva/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
