...
Manage companies within your Proactiva instance.
...
Company logo uploads use the normal Proactiva attachment size limit.
...
| `logoUrl` | string | Optional Proactiva asset content path for the stored logo image |
