...
import * as serverUtils from "@proactiva/adapter-utils/server-utils";
export type { RunProcessResult } from "@proactiva/adapter-utils/server-utils";
...
export const buildProactivaEnv = serverUtils.buildProactivaEnv;
