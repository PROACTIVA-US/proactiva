 ...
 *
 * These components are exported from `@proactiva/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@proactiva/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function ProactivaSdkUiComponent(props: TProps) {
