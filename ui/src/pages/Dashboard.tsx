...
import type { Agent, Issue } from "@proactiva/shared";
    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message="Welcome to Proactiva. Set up your first company and agent to get started."
          action="Get Started"
          onAction={() => navigate("/new-company")}
        />
      );
    }
    return (
