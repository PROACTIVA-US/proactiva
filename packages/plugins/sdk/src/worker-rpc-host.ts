...
import type { ProactivaPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@proactiva/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: ProactivaPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@proactiva/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
