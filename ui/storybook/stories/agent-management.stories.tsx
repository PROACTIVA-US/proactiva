...
import { storybookAgents, storybookIssues } from "../fixtures/proactivaData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        PROACTIVA_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "proactiva-storybook", priority: "normal" }, null, 2),
      env: {
        ...
        <main className="proactiva-story__inner space-y-6">
          <section className="proactiva-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="proactiva-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Proactiva fixtures.",
      },
    },
  },
