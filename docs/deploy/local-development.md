...
summary: Set up Proactiva for local development
---

Run Proactiva locally with zero external dependencies.
...
No Docker or external database required. Proactiva uses embedded PostgreSQL automatically.
...
To open Proactiva to a private network with login enabled:
