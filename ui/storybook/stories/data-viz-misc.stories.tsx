...
import type { HeartbeatRun, Issue } from "@proactiva/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Proactiva Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII proactiva field"}>
