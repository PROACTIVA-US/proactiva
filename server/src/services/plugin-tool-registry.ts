...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@proactiva/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: ProactivaPluginManifestV1, pluginDbId?: string): void;
