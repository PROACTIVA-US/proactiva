...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@proactiva/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative proactiva-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("proactiva-mdxeditor", !bordered && "proactiva-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "proactiva-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
