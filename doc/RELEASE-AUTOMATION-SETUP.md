...
This document covers the GitHub and npm setup required for the current Proactiva release model:
...
Do this for every public package that Proactiva publishes.
...
3. add a trusted publisher for the GitHub repository `proactiva/proactiva`
...
2. revoke any personal automation token that used to publish Proactiva
