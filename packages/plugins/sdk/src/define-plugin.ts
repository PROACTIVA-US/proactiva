/**
 * `definePlugin` — the top-level helper for authoring a Proactiva plugin.
 *
...
// ---------------------------------------------------------------------------
// ProactivaPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface ProactivaPlugin {
 ...
 * @returns A sealed `ProactivaPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@proactiva/plugin-sdk";
