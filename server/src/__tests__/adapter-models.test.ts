...
import { models as codexFallbackModels } from "@proactiva/adapter-codex-local";
import { models as cursorFallbackModels } from "@proactiva/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@proactiva/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@proactiva/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.PROACTIVA_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.PROACTIVA_OPENCODE_COMMAND = "__proactiva_missing_opencode_command__";
