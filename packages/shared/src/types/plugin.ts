...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within ProactivaPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Proactiva host.
 *
...
export interface ProactivaPluginManifestV1 {
   ...
   */
  minimumProactivaVersion?: PluginMinimumHostVersion;
