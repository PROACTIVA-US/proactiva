...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Proactiva state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".proactiva/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/proactiva",
      ),
    ).toBe(false);
