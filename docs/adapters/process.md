...
- Running a Python script that calls the Proactiva API
...
1. Proactiva spawns the configured command as a child process
2. Standard Proactiva environment variables are injected (`PROACTIVA_AGENT_ID`, `PROACTIVA_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Proactiva API and perform work.
