 ...
 * toggle server-side adapter code for the whole Proactiva instance.
 *
...
interface AdapterInstallRequest {
  /** npm package name (e.g., "droid-proactiva-adapter") or local path */
  packageName: string;
...
export function adapterRoutes() {
  ...
  // without modifying Proactiva's source code.
  //
