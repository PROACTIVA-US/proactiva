 ...
 *
 * When the Proactiva UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and Proactiva's UI loads it on demand.
 */

import type { TranscriptEntry } from "@proactiva/adapter-utils";
