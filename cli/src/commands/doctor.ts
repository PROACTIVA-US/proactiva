...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" proactiva doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `proactiva configure --section database` or `proactiva onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadProactivaEnvFile(input.configPath);
