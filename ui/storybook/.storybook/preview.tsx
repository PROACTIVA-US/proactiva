...
function installStorybookApiFixtures() {
  ...
  const currentWindow = window as typeof window & {
    __proactivaStorybookFetchInstalled?: boolean;
  };
  if (currentWindow.__proactivaStorybookFetchInstalled) return;

  const originalFetch = window.fetch.bind(window);
  currentWindow.__proactivaStorybookFetchInstalled = true;
...
const preview: Preview = {
  ...
  globalTypes: {
    theme: {
      description: "Proactiva color mode",
      defaultValue: "dark",
      toolbar: {
        title: "Theme",
        icon: "mirror",
