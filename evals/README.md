...
Eval framework for testing Proactiva agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Proactiva heartbeat skill:
