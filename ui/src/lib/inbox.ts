...
export const DISMISSED_KEY = "proactiva:inbox:dismissed";
export const READ_ITEMS_KEY = "proactiva:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "proactiva:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "proactiva:inbox:issue-columns";
export const INBOX_NESTING_KEY = "proactiva:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "proactiva:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "proactiva:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "proactiva:inbox:collapsed-groups";
