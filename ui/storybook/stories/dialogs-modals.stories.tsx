...
import {
  ...
  storybookIssues,
  storybookProjects,
} from "../fixtures/proactivaData";

const COMPANY_ID = "company-storybook";
const SELECTED_COMPANY_STORAGE_KEY = "proactiva.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "proactiva:issue-draft";

const storybookGoals: Goal[] = [
  {
    id: "goal-company",
    companyId: COMPANY_ID,
    title: "Build Proactiva",
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .proactiva/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/proactiva",
    workspacePath: "/Users/dotta/proactiva/.proactiva/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "https://github.com/PROACTIVA-US/proactiva");
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/proactiva/ui");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Proactiva creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
