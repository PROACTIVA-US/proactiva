...
import type { Agent, FeedbackVote, IssueComment } from "@proactiva/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/proactivaData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Proactiva work: checkout, comments, linked runs, and review feedback.",
    ...
    <div className="proactiva-story">
      <main className="proactiva-story__inner space-y-6">
        <section className="proactiva-story__frame p-6">
          <div className="proactiva-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Proactiva operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="proactiva-story">
      <main className="proactiva-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
