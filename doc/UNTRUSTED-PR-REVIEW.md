...
This is intentionally separate from the normal Proactiva dev image.
...
```sh
review-checkout-pr proactiva/proactiva 432
cd /work/checkouts/proactiva-proactiva/pr-432
```
...
## Preview the Proactiva app from the PR
...
- Proactiva's embedded PostgreSQL and local storage stay inside the container home volume via `PROACTIVA_HOME=/home/reviewer/.proactiva-review`.
