...
const manifest: ProactivaPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Proactiva plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Proactiva",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Proactiva domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
