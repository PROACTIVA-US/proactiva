...
- installed adapter list for this Proactiva instance
...
## 8. New Skill: `proactiva-create-agent`

Create new skill directory:

- `skills/proactiva-create-agent/SKILL.md`
...
Also update `skills/proactiva/SKILL.md` to reference this skill for hiring workflows.
...
- `proactiva-create-agent` skill + docs updates
