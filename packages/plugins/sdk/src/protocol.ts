 ...
 * channel.
 *
 * The Proactiva plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@proactiva/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Proactiva messages.
 */
...
/**
 * Proactiva plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Proactiva instance. */
    instanceId: string;
    /** Semver version of the running Proactiva host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
