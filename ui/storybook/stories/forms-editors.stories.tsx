...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@proactiva/shared";
...
import { createIssue, storybookAgents } from "../fixtures/proactivaData";
...
function Section({
  ...
  return (
    <section className="proactiva-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="proactiva-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="proactiva-story">
      <main className="proactiva-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/PROACTIVA-US/proactiva).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Proactiva secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @proactiva/ui typecheck", "pnpm build-storybook"],
...
const routineVariables: RoutineVariable[] = [
  {
    ...
    label: "Repository",
    type: "text",
    defaultValue: "proactiva/proactiva",
    required: true,
    options: [],
  },
  {
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Proactiva" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    repoUrl: "https://github.com/PROACTIVA-US/proactiva",
    repoRef: "master",
    defaultRef: "master",
    repoName: "proactiva",
    localFolder: "/Users/dotta/proactiva",
    managedFolder: "proactiva",
    effectiveLocalFolder: "/Users/dotta/proactiva",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="proactiva-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="proactiva-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Proactiva form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Proactiva form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
