...
import { pluginManifestV1Schema, type ProactivaPluginManifestV1 } from "@proactiva/shared";
...
function manifest(apiRoutes: NonNullable<ProactivaPluginManifestV1["apiRoutes"]>): ProactivaPluginManifestV1 {
  return {
    id: "proactiva.scoped-api-test",
    apiVersion: 1,
    version: "1.0.0",
