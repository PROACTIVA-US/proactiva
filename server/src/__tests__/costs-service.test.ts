...
import { createDb, companies, agents, costEvents, financeEvents, projects } from "@proactiva/db";
...
describeEmbeddedPostgres("cost and finance aggregate overflow handling", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("proactiva-costs-service-");
