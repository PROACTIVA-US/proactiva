/**
 * `@proactiva/plugin-sdk/ui` — Proactiva plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@proactiva/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@proactiva/plugin-sdk/ui";
 *
