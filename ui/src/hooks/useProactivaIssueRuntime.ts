...
export interface ProactivaIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface ProactivaIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: ProactivaIssueRuntimeReassignment;
}

interface UseProactivaIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: ProactivaIssueRuntimeSendOptions) => Promise<void>;
...
export function useProactivaIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseProactivaIssueRuntimeOptions) {
