CREATE TABLE IF NOT EXISTS "feedback_exports" (
	...
	"schema_version" text DEFAULT 'proactiva-feedback-envelope-v2' NOT NULL,
	"bundle_version" text DEFAULT 'proactiva-feedback-bundle-v2' NOT NULL,
	"payload_version" text DEFAULT 'proactiva-feedback-v1' NOT NULL,
	"payload_digest" text,
