 ...
 *
 * This is placed on `globalThis.__proactivaPluginBridge__` and consumed by
...
declare global {
  ...
  var __proactivaPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__proactivaPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__proactivaPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
