import type { PluginLauncherRegistration } from "@proactiva/plugin-sdk";

export const PLUGIN_ID = "proactiva-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".proactiva-kitchen-sink-demo.txt",
} as const;
