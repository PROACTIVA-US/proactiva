/**
 * PluginEventBus — typed in-process event bus for the Proactiva plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@proactiva/shared";
import type { PluginEvent, EventFilter } from "@proactiva/plugin-sdk";
