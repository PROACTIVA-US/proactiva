...
Proactiva supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Proactiva?** Use `local_trusted` (the default)
