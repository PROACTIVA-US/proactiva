...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@proactiva/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Proactiva file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Proactiva storage.";
